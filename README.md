...
# Execute the commands below in your KOPS control Server. use unique s3 bucket name. If you get bucket name exists error.
	...
	export KOPS_STATE_STORE=s3://sheyiclass29
...
# 8) Create kubernetes cluster definitions on S3 bucket
	...
	kops create cluster --zones us-east-1c --networking weave --master-size t2.medium --master-count 1 --node-size t2.micro --node-count=2 ${NAME}
...
# 11) connect to the master node
    ...
    ssh -i ~/.ssh/id_rsa ubuntu@54.167.39.119
